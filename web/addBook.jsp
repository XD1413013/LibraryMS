         ...
         <div class="banner-form" style="margin-top: 50px">
             <div class="container">
                <%
                    if (user_name != null) {
                %>
                     <form action="AddBookServlet" method="post" name="addbook">
                         <br>
                         <select name="location">
                             <option value="1F001">1F001</option>
                             <option value="1F002">1F002</option>
                             <option value="2F001">2F001</option>
                             <option value="3F001">3F001</option>
                         </select>
                         <input type="text" value="" placeholder="Scan the ISBN" name="isbn"><br>
                         <br>
