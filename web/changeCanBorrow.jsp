    ...
    <div class="banner-form" style="margin-top: 50px">
        <div class="container">
            <%
                if (user_name != null) {
            %>
            <form action="ChangeCanBorrowServlet" method="post" name="change">
                <br>
                <select name="can_borrow">
                    <option value="0">Can not Borrow</option>
                    <option value="1">Can Borrow</option>
                </select>
                <br>
