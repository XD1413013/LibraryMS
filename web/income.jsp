    ...
    <div class="banner-form" style="margin-top: 50px">
        <div class="container" style="margin-top: 50px;">
            ...
            <form action="StatisticsServlet" method="post">
                <label for="start" style="font-size: larger; color: #5cb85c">Start Time: </label><input id="start" type="date" value="2017-11-13" name="startTime">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label for="end" style="font-size: larger; color: #5cb85c">End Time: </label><input id="end" type="date" value="2017-11-16" name="endTime">
                <br>
                <br>
                <br>
                <br>
                ...
                <br>
                <br>
                <input type="submit" value="Income Statistics">
            </form>
            <%
            } else {
            %>
