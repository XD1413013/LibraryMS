...
<body>
	...
	<div id="home" class="banner">
		...
		<div class="top-menu">
			<div id="top">
					<%
						if (id == null || !id.equals(reader.getReader_id())) {
					%>
			...
			<div class="container" id="list">
				<nav class="cl-effect-1"> <span class="menu"><img src="images/nav-icon.png" alt="" /></span>
					<%
						if (id != null && id.equals(reader.getReader_id()) && reader.getReader_status().equals("1")) {
					%>
					<table align="center" border="1" width="100%" style="border-collapse: separate; border-spacing: 20px;">
						...
						<tr>
							...
							<td>***********</td>
							<td><%=reader.getReader_name()%></td>
							<td><%=reader.getReader_sex()%></td>
							<td><%=reader.getReader_email()%></td>
							<td><%=reader.getReader_phone()%></td>
						</tr>

						<tr>
								<td></td>
								<td><a href="ModifyPwd.jsp">Modify</a>
								</td>
								<td></td>
								<td></td>
								<td>
									<a href="Modifyemail.jsp">Modify</a>
								</td>
								<td>
									<a href="Modifyphone.jsp">Modify</a>
								</td>
						</tr>
					</table>
				</nav>
